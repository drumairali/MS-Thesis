...
#3665.457999944687 till this time plotting
  figure(2);
  hold on;
  plot (dgpsData(1:3660,2),  dgpsData(1:3660,3), 'k',"LineWidth", 1);
  plot (allpcbc(:,2),  allpcbc(:,3), 'm',"LineWidth", 1);
  plot (usblData(1:1450,2), usblData(1:1450,3), '.b',"LineWidth", 1);
  legend("DGPS","PC/BC-DIM","USBL")
  axis("equal", "tight");
  set(gca,'FontSize',20)
