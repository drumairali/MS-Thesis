...
muUSBL = muODOM = zeros(1,ns); % 0 0 0

### Kalman filter 1: theta estimate
global ns1 = 1; % theta 1

sigmaCompass = [0.02]*(pi/180); % deg 0.00034907
sigmaThetaODOM = [0.7]*(pi/180); % deg 0.012217

global R1 = eye(ns1)*sigmaCompass; %; 0.00034907 observation noise covariance 
global Q1 = eye(ns1)*sigmaThetaODOM; %; 0.012217 process noise covariance 
