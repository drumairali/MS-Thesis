...
hold on 
plot3(globalTraj(:,2),globalTraj(:,3),globalTraj(:,4))
hold off  
figure(2)
plot3(gtData(:,2),gtData(:,3),gtData(:,4))
hold on 
plot3(allB_PR_F_Mus(2,:),allB_PR_F_Mus(3,:),allB_PR_F_Mus(4,:))
hold off
immse(gtData(:,2+1),globalTraj(:,2+1))
immse(gtData(2:6301,2+1),(allB_PR_F_Mus(2+1,:))')
...
plot(gtData(:,2))
hold on
plot(allB_PR_F_Mus(2,:))
title("BPRF X-Axis")

subplot(2,3,2)
plot(gtData(:,3))
hold on
plot(allB_PR_F_Mus(3,:))
title("BPRF Y-Axis")

subplot(2,3,3)
plot(gtData(:,4))
hold on
plot(allB_PR_F_Mus(4,:))
title("BPRF Z-Axis")
...
hold on
plot(globalTraj(:,2))
title("PCBC-DIM X-Axis")

subplot(2,3,5)
plot(gtData(:,3))
hold on
plot(globalTraj(:,3))
title("PCBC-DIM Y-Axis")

subplot(2,3,6)
plot(gtData(:,4))
hold on
plot(globalTraj(:,4))
title("PCBC-DIM Z-Axis")
